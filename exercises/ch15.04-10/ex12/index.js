...
document.querySelector("#all").addEventListener("click", (e) => {
  e.preventDefault();
  window.history.pushState(null, "", "https://127.0.0.1:5500/exercises/ch15.04-10/ex12/index.html/all");
  renderTodos(todos);
});

document.querySelector("#active").addEventListener("click", (e) => {
  e.preventDefault();
  window.history.pushState(null, "", "https://127.0.0.1:5500/exercises/ch15.04-10/ex12/index.html/active");
...
document.querySelector("#completed").addEventListener("click", (e) => {
  e.preventDefault();
  window.history.pushState(null, "", "https://127.0.0.1:5500/exercises/ch15.04-10/ex12/index.html/completed");
